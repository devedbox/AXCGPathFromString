...
CGPathRef CGPathCreateMultilineStringWithAttributedString(NSAttributedString *attrString, CGFloat maxWidth, CGFloat maxHeight)
{
    ...
    CGAffineTransform transform = CGAffineTransformConcat(CGAffineTransformTranslate(t, 0, -pathBounds.size.height), CGAffineTransformMakeTranslation(-pathBounds.origin.x, -pathBounds.origin.y));
