...
+ (UIBezierPath *)bezierPathForString:(NSString *)string withFont:(UIFont *)font
{
    ...
    return [self bezierPathForAttributedString:attrString];
}

+ (UIBezierPath *)bezierPathForMultilineString:(NSString *)string withFont:(UIFont *)font maxWidth:(CGFloat)maxWidth textAlignment:(NSTextAlignment)alignment

{
    ...
    return [self bezierPathForMultilineAttributedString:attrString maxWidth:maxWidth];
}


#pragma mark - NSAttributedString
+ (UIBezierPath *)bezierPathForAttributedString:(NSAttributedString *)string
{
...
+ (UIBezierPath *)bezierPathForMultilineAttributedString:(NSAttributedString *)string maxWidth:(CGFloat)maxWidth
{
